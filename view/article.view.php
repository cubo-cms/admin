		...
		return (object)[
			...
			'content-pane'=>[
				...
				'right'=>[
					...
					[ 'name'=>'category', 'class'=>'form-control form-control-sm', 'prefix'=>($new ? ':' : ''), 'query'=>Form::query('category',Session::isAccessible()), 'title'=>'Category', 'type'=>'select', 'value'=>($_Data->category ?? CATEGORY_UNDEFINED) ],
